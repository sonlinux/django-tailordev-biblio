...
# Grapelli settings
GRAPPELLI_ADMIN_TITLE = 'Td-Biblio Admin Page'
...
# For heroku default postgres database
...
# This we may not need but in for scaling purpose in case extend apps
# features to need more resources
